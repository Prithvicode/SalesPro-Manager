...
$requestedOrders = [];
    ...
    $pendingOrderSql = "SELECT orders.*, CONCAT(users.FirstName, ' ', users.LastName) AS Name
                        ...
                        AND orders.ProductionStatus = 'Started';
...
<script>
    ...
    showOrderDetailsLinks.forEach(function (link) {
        link.addEventListener("click", function (event) {
            ...
            iframeContent.src = `http://localhost/InventoryAndSalesManagement/frontend/pages/productionStaff/orderDetail.php?id=${orderId}&start=yes`;
