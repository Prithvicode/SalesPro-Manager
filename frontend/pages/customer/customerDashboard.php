            ...
            <div class="card-container">
                <div class="sales-cards">
                    ...
                    <div class="sales-row">
                        ...
                        <div class="cards">
                            <img src="<?php echo $BASE_URL?>/images/icons/cancel_order.png" id="total-delivery" class="card-logo" alt="" />
                            <div class="cards-details">
                ...
                <div class="sales-cards">
                    ...
                    <div class="sales-row">
                        <div class="cards">
                            <img src="<?php echo $BASE_URL?>/images/icons/in_production.png" id="total-sales" class="card-logo" alt="" />
                            <div class="cards-details">
